...
public class Robot extends TimedRobot {
   ...
   */
  CANSparkMax driveLeftSparkA = new CANSparkMax(1, MotorType.kBrushless);
  CANSparkMax driveRightSparkA = new CANSparkMax(2, MotorType.kBrushless);
  CANSparkMax driveLeftSparkB = new CANSparkMax(3, MotorType.kBrushless);
  CANSparkMax driveRightSparkB = new CANSparkMax(4, MotorType.kBrushless);
  ...
  public void autonomousInit() {
    driveLeftSparkA.setIdleMode(IdleMode.kBrake);
    driveLeftSparkB.setIdleMode(IdleMode.kBrake);
    driveRightSparkA.setIdleMode(IdleMode.kBrake);
    driveRightSparkB.setIdleMode(IdleMode.kBrake);
